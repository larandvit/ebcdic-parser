...
|[BINARY 8 bytes](https://github.com/larandvit/ebcdic-parser/blob/master/docs/cobol_binary_type.md)|PIC S9(11) to S9(19) COMP or PIC 9(11) to 9(19) COMP|integer|8|-|-9223372036854775808 to 9223372036854775807|
